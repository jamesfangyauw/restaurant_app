...
class RestaurantSearch {
  ...
  bool error;
  int founded;
  List<RestSearch> restaurants;

  factory RestaurantSearch.fromJson(Map<String, dynamic> json) => RestaurantSearch(
    error: json["error"],
    founded: json["founded"],
    restaurants: List<RestSearch>.from(
        json["restaurants"].map((x) => RestSearch.fromJson(x))),
  );
...
class RestSearch {
  ...
  factory RestSearch.fromJson(Map<String, dynamic> json) =>
      RestSearch(
        id: json["id"],
        name: json["name"],
